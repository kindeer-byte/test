    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "id": "psy_q13",
          "type": "single",
          "text": "Бывает ли, что из-за страха не уложиться в KPI ты пропускаешь перерывы, ешь за компом или работаешь сверхурочно без оплаты?",
          "options": [
            { "id": "a", "text": "Никогда", "score": 0 },
            { "id": "b", "text": "Редко", "score": 1 },
            { "id": "c", "text": "Часто", "score": 2 },
            { "id": "d", "text": "Почти каждый день", "score": 3 }
          ]
        }
      ]
    }
